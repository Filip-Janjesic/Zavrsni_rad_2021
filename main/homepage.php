...
<div class="container">
    ...
    <p>Farm meeting in its system there are more than 10 halls in the city with different dates, just choose what suits you best!</p>
    <hr>
    <h4>Farm meeting in numbers:</h4>
    <p>Farm meeting currently has <?=$userbroj[0][0]?> system users.</p>
    <p>Farm meeting currently has <?=$gamebroj[0][0]?> scheduled meetings in your system.</p>
</div>